<h1 align="center"><picture><source media="(prefers-color-scheme: light)" srcset="https://github.com/UMEBOSHIISAN/toygarden/raw/main/assets/logo-light.svg"><img src="https://github.com/UMEBOSHIISAN/toygarden/raw/main/assets/logo.svg" alt="toygarden" width="420"></picture></h1>

> **A construction kit where terminal toys grow.**
> 日本語版 → **[README.ja.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/README.ja.md)**
...
[![license: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/UMEBOSHIISAN/toygarden/blob/main/LICENSE)
[![node](https://img.shields.io/badge/node-%3E%3D22-brightgreen.svg)](https://github.com/UMEBOSHIISAN/toygarden/blob/main/package.json)
[![dependencies: zero](https://img.shields.io/badge/dependencies-zero-brightgreen.svg)](https://github.com/UMEBOSHIISAN/toygarden/blob/main/package.json)
[![demos: rendered from code](https://img.shields.io/badge/demos-rendered%20from%20code-ff69b4.svg)](#demos-that-dont-rot)

![toygarden](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/banner.gif)
...
- 🔌 **Gadget people (M5Stack, macropads)** — start with
  ...
  terminal, then read **[docs/DEVICES.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/docs/DEVICES.md)** and write a driver in
...
- 🤖 **Agent people** — the toys visualize how autonomous agents actually behave.
  [git-replay](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/git-replay.gif) color-codes human vs. AI commits,
  [commit-symphony](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/commit-symphony.gif) rings AI co-authored commits an
  octave up, and [agent-constellation](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/agent-constellation.gif),
  [routing-radar](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/routing-radar.gif), and
  [collapse-siren](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/collapse-siren.gif) turn dispatch, routing, and
...
[`contracts/events.ts`](https://github.com/UMEBOSHIISAN/toygarden/blob/main/contracts/events.ts): a producer never knows who's
listening, a consumer never knows who spoke. That shared vocabulary is the spine
of the whole kit.

![how it works](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/how-it-works.gif)
...
![event-loom](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/event-loom.gif)
...
|---|---|
| [`core-events`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-events/) | event bus — decouples producers from consumers |
| [`core-device`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-device/) | device HAL (M5 / Ajazz AKP153 / mock) |
| [`core-git-observe`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-git-observe/) | git activity observation (numstat + Co-Authored-By) |
| [`core-chiptune`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-chiptune/) | 8-bit sound (square-wave PCM / WAV / motifs) |
| [`core-tui`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-tui/) | terminal UI primitives (lanes / badges / ANSI) |
| [`core-worker-data`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-worker-data/) | worker dispatch / collapse data supply (read-only) |
| [`core-focus-log`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-focus-log/) | focus-cam log (sqlite) supplied read-only |
| [`core-save`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-save/) | fail-soft, zero-dependency JSON persistence for small states in `~/.toygarden` |
| [`core-sysmon`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-sysmon/) | host workload (CPU / memory / load via `node:os`) normalized to a 0..1 busyness score |
| [`core-termgif`](https://github.com/UMEBOSHIISAN/toygarden/tree/main/packages/core-termgif/) | ANSI output → GIF. The part that keeps demos from rotting (GIF89a + LZW + a built-in 8×8 font) |

## Toy catalog (`apps/` — all 22, all with GIFs)

**Full gallery → [demo/index.html](https://github.com/UMEBOSHIISAN/toygarden/blob/main/demo/index.html)** — self-contained, filter by
core, dark/light aware, zero external references. Regenerate with `npm run showcase`.

| toy | cores crossed | what it does |
|---|---|---|
| [ascii-aquarium](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/ascii-aquarium.gif) | contracts | An ASCII fish tank that gains a fish on every `task.done`. A moon rises at night. |
| [event-loom](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/event-loom.gif) | events × tui | Weaves every event on one bus into a live universal viewer. |
| [commit-symphony](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/commit-symphony.gif) | git-observe × chiptune | Your git history becomes an 8-bit tune; AI co-authored commits ring an octave up. |
| [git-replay](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/git-replay.gif) | git-observe × tui | Time-lapse playback of a repo's history, human and AI color-coded. |
| [secretary-today](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/secretary-today.gif) | tui | Today's priorities as lanes; blocked items sink in red. |
| [agent-constellation](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/agent-constellation.gif) | device × events | Agents become a constellation; a dispatch draws a line between stars. |
| [collapse-arcade](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/collapse-arcade.gif) | worker-data | High collapse-rate agents become enemies. Shooting one = a review. Your best score saves RPG-style to `~/.toygarden/save.json` — brag about it with the 🏆 issue template. |
| [collapse-siren](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/collapse-siren.gif) | worker-data × chiptune × events | When collapse rate crosses a threshold, the terminal blares a dissonant siren. |
| [device-mirror](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/device-mirror.gif) | device | See the hardware before you buy it: a virtual M5Stack panel in your terminal, mirroring the `DrawCommand`s a real driver would receive. |
| [desk-weather](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/desk-weather.gif) | device | Your repo's health becomes desk weather; a dirty tree clouds over. |
| [git-weather](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/git-weather.gif) | git-observe × device | High-churn days storm, quiet days stay clear. |
| [pomodoro-forge](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/pomodoro-forge.gif) | chiptune × device | Mine ore by focusing, smelt it on commit — a blacksmith's pomodoro. |
| [focus-forge](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/focus-forge.gif) | focus-log × chiptune × device | A pomodoro that isn't self-reported. Only measured focus swings the hammer. |
| [focus-aquarium](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/focus-aquarium.gif) | focus-log | A day's focus log swims out as a school of fish at night. |
| [focus-tally](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/focus-tally.gif) | focus-log × tui | What you did today stacks up as a terminal bar chart. |
| [ume-tamagotchi](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/ume-tamagotchi.gif) | contracts | Raise Umeko: she's happy when you post, sulks when things stall. |
| [routing-slot](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/routing-slot.gif) | worker-data | Worker dispatch as a slot machine; the right fit hits the jackpot. |
| [routing-radar](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/routing-radar.gif) | worker-data × tui | A radar surveying dispatch hit-rate with confidence bars. |
| [chiptune-clock](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/chiptune-clock.gif) | chiptune × device | A desk clock that tells the hour with an 8-bit bell. |
| [chiptune-themes](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/chiptune-themes.gif) | chiptune × events | Each event kind gets a theme; a successful deploy plays a fanfare. |
| [commit-constellation](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/commit-constellation.gif) | git-observe × device | Commit authors become stars; the bigger the contribution, the brighter. |
| [cpu-diner](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/cpu-diner.gif) | sysmon | An ASCII diner run by your machine's workload: customers flood in when your CPU sweats, the staff doze when it's idle. |
...
![device-mirror](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/device-mirror.gif)
...
**[docs/DEVICES.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/docs/DEVICES.md)**.
...
here — it's playable. [commit-symphony](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/commit-symphony.gif) sings this
repo's own log, ringing the AI co-authored commits an octave up;
[git-replay](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/gifs/git-replay.gif) replays the same history with human and AI
...
- Each app exports `demo(): DemoSpec` from `src/demo.ts` (the convention lives in
  [`packages/core-termgif/README.md`](https://github.com/UMEBOSHIISAN/toygarden/blob/main/packages/core-termgif/README.md)).
...
<img src="https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/crt/ascii-aquarium.gif" alt="CRT-filtered ascii-aquarium" width="360">
...
new core, device, or event): **[CONTRIBUTING.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/CONTRIBUTING.md)**.
...
![combination frontier](https://github.com/UMEBOSHIISAN/toygarden/raw/main/demo/frontier.gif)
...
[Grab a `toy-idea`](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=toy-idea.yml) or
[propose a core](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=new-core.yml).
...
- 🧸 **A new toy** — `npm run new -- my-toy` scaffolds a living app in ~60 seconds.
  ...
  an idea? Your first one can come from a prompt — [browse the `toy-idea` issues](https://github.com/UMEBOSHIISAN/toygarden/issues?q=is%3Aissue+is%3Aopen+label%3Atoy-idea) and build one.
...
- 📡 **A new event** — add one line to the `PlayEvent` type in
  [`contracts/events.ts`](https://github.com/UMEBOSHIISAN/toygarden/blob/main/contracts/events.ts) and every producer and consumer
...
- 🧸 [Suggest a toy](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=toy-idea.yml) ·
  🧩 [Propose a new core](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=new-core.yml) ·
  🔌 [Bring a device driver](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=device-driver.yml) ·
  🏆 [Brag a collapse-arcade score](https://github.com/UMEBOSHIISAN/toygarden/issues/new?template=high-score.yml)
- PRs welcome — the checklist is in [CONTRIBUTING.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/CONTRIBUTING.md) and the
  [pull request template](https://github.com/UMEBOSHIISAN/toygarden/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
Read **[CONTRIBUTING.md](https://github.com/UMEBOSHIISAN/toygarden/blob/main/CONTRIBUTING.md)**. The only rules that matter: keep the
...
MIT — see [LICENSE](https://github.com/UMEBOSHIISAN/toygarden/blob/main/LICENSE). The bitmap font's provenance is public domain
(see [`core-termgif/README.md`](https://github.com/UMEBOSHIISAN/toygarden/blob/main/packages/core-termgif/README.md)).
