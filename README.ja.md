...
npm run hello            # Undertale 風の案内役が中へ連れていく
...
npm run check            # typecheck + テスト（25 files / 125 tests）
...
core-termgif の LZW は独立実装デコーダとの roundtrip でテストしている。**25 files / 125 tests。**
